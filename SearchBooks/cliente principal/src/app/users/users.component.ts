...
import {DialogContentExampleDialog} from './dialog-content/dialog.component'
...
export class UsersComponent implements OnInit {
  ...
  constructor(private service: UsersService,private cookiesService: CookiesmanagementService, private snackBar: MatSnackBar, public dialog: MatDialog) {
