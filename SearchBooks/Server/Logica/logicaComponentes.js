...
exports.agregarUsuarioDepartamento= function(datos, callback){
    consultsPreparer.insertarUsuarioDepartamento(datos, function(response) {
        msg = (response.error == 1) ? "Error de conexión" : "Credenciales incorrectas";
        if (response.success) {
            callback({
                success: true,
...
exports.asignarPermisos= function(datos, callback){
    consultsPreparer.asignarPermisos(datos, function(response) {
        msg = (response.error == 1) ? "Error de conexión" : "Credenciales incorrectas";
        if (response.success) {
            callback({
                success: true,
...
exports.eliminarUsuarios= function(datos, callback){
    consultsPreparer.eliminarUsuario(datos, function(response) {
        msg = (response.error == 1) ? "Error de conexión" : "Credenciales incorrectas";
        if (response.success) {
            callback({
                success: true,
